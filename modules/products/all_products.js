...
const AllProducts = () => {
  ...
  const fetchProducts = async () => {
    ...
    // ip address aka http://192.168.1.143:8010/ for actual android app
      const response = await fetch(`http://192.168.1.143:8010/products/${user_id}`, {
          method: 'GET',
          headers: {
  ...
  modalButton: {
    padding: 15,
    backgroundColor: 'white',  // A contrasting color against purple
    borderRadius: 8,
    marginVertical: 10,  // To space the buttons vertically
